...
export default function MediaGrid({
  ...
  return (
    <div className="w-full max-w-full p-10 md:p-6 overflow-hidden">
      <div
        className={`grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-1 w-full transition-all duration-500 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] ${
          isTransitioning
      ...
      >
        {displayedMedia.map((item, index) => {
          ...
          return (
            <div
              key={item.public_id}
              className={`group relative bg-gray-900 rounded-lg overflow-hidden cursor-pointer aspect-[4/3] md:aspect-[3/2] md:max-h-[20vh] ${
